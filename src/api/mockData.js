...
export const mockBarbers = [
  {
    ...
    specialty: ["Classic Cuts", "Hot Towel Shave", "Beard Trim"],
    experience_years: 15,
    rating: 4.9,
    reviews_count: 234,
    is_active: true,
  ...
  },
  {
    ...
    specialty: ["Modern Fades", "Skin Fades", "Creative Styles"],
    experience_years: 8,
    rating: 4.8,
    reviews_count: 187,
    is_active: true,
  ...
  },
  {
    ...
    specialty: ["Beard Styling", "Grooming", "Beard Maintenance"],
    experience_years: 12,
    rating: 4.7,
    reviews_count: 156,
    is_active: true,
...
export const mockBlogPosts = [
  {
    ...
    excerpt:
      "Discover the latest hairstyle trends that are dominating the grooming scene this year.",
...
Visit us at Privé to get any of these trending styles from our expert barbers!`,
  ...
  },
  {
    ...
    excerpt:
      "Learn the fundamentals of maintaining a healthy, great-looking beard.",
...
Book a beard consultation with our specialists at Privé!`,
  ...
  },
  {
    ...
    excerpt:
      "A guide to choosing the perfect hairstyle based on your facial features.",
...
export const mockReviews = [
  {
    ...
    rating: 5,
    comment:
      "James is an absolute master! Best haircut I've ever had. Will definitely be back.",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "David transformed my beard completely. Great attention to detail.",
