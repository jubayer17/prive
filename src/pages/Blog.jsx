    ...
    <div className="min-h-screen bg-white pt-24">
      ...
      <section className="bg-stone-900 py-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-light text-white mb-4">The Hairy Journal</h1>
                ...
                >
                  <Link to={`${createPageUrl('BlogPost')}?id=${featuredPost.id}`}>
                    <div className="relative rounded-3xl overflow-hidden group cursor-pointer">
                      <img
                        src={featuredPost.cover_image || 'https://images.unsplash.com/photo-1622286342621-4bd786c2447c?w=1200'}
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12">
                        ...
                        <div className="flex items-center gap-6 text-sm text-stone-400">
                          ...
                          <span className="flex items-center gap-2">
                            ...
                            {featuredPost.published_date && format(new Date(featuredPost.published_date), 'MMM d, yyyy')}
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <Link to={`${createPageUrl('BlogPost')}?id=${post.id}`}>
                      <div className="group cursor-pointer">
                        <div className="relative rounded-2xl overflow-hidden mb-4">
                          <img
                            src={post.cover_image || 'https://images.unsplash.com/photo-1622286342621-4bd786c2447c?w=600'}
                            alt={post.title}
